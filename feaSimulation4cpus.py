...
class feaSimulation4cpus:
    ...
    def executeShell(self):
        ...
        subprocess.Popen(('abaqus job='+self.simName+' user='+self.userDir+'vumat.for cpus=4'), shell=True, cwd=(self.subDir+self.simName))        
        #subprocess.Popen(('abaqus job='+self.simName+' cpus=4'), shell=True, cwd=(self.subDir+self.simName))
